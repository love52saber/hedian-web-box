 ...
 * @Last Modified time: 2018-12-04 14:10:46
...
window.config = {
   ...
   */
  baseUrl: 'http://192.168.1.81:8099', // 开发环境请求基础路径
  // baseUrl: 'http://192.168.1.23:8099', // 生产环境请求基础路径，开发进行中需要被注释

  /**
   * @description 文件服务地址
   */
  fileHost: 'http://192.168.1.81:9005/znyw', // 开发环境文件服务地址
  // fileHost: 'http://192.168.1.23:9005/znyw', // 生产环境文件服务地址

  /**
   * @description websocket地址
   */
  wsUrl: 'ws://192.168.1.81:8099/api/websocket/' // 开发环境websocket地址
